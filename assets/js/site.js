...
(function ($) {
    const pages = ["challenge-badges", "resources", "thanks-awards-and-recognition","share-with-us","your-county-team","volunteer-vacancies"]; //classes added to main-content section used to filter which pages this runs on
